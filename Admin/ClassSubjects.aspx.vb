...
Partial Class ClassSubjects
    ...
    Protected Sub ddlClass_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlClass.SelectedIndexChanged
        ListBox1.DataSource = BLL.ExecDataTable("select * from subjectmaster")
        ...
        ListBox2.DataSource = BLL.ExecDataTableProc("Get_ClassSubjectsAll", "@classid", ddlClass.SelectedValue)
        ListBox2.DataTextField = "Subjectname"
        ListBox2.DataValueField = "subjectid"
        ListBox2.DataBind()
    ...
    Protected Sub btn1_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            lbltxt.Visible = True
            lbltxt.Text = Notifications.ErrorMessage("Please select atleast one in Subject Listbox to move.")
        End If
    End Sub
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            If ListBox2.Items.Count > 0 Then
                ...
                Next
                BLL.ExecNonQueryProc("Prc_SaveClassSubjects", "@ClassId", ddlClass.SelectedValue, "@SubjectIds", subjstr)
                lbltxt.Text = Notifications.SuccessMessage("Subjects Submitted Successfully")
            Else

            End If
        Catch ex As Exception
            lbltxt.Text = Notifications.ErrorMessage("Please Subject Subject.")
        End Try
