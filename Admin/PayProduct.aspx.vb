...
Partial Class Admin_PayProduct
    Inherits BasePage
    ...
    End Sub
    Sub bind()
        Dim dt As DataTable = BLL.ExecDataTable("select * from ProductReceiptMaster where paiddate is null order by cnt desc")
    ...
    Protected Sub DataDisplay_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataDisplay.RowCommand
        ...
        If e.CommandName = "paid" Then
            Dim dr As SqlDataReader = BLL.ExecDataReader("select * from ProductReceiptMaster  where cnt=@cnt", "@cnt", e.CommandArgument)
            If dr.Read() Then
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim res As String = BLL.PayProduct(txtReceiptno.Text, txtDueDate.Text, txtremark.Text, txtlatefees.Text, ddlpmode.SelectedValue, "", "", 0, "", "", 0, "2018-2019")
            If res.Chars(0) = "" Then
