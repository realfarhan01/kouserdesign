<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="ExamStudentWise.aspx.vb" Inherits="Admin_ExamStudentWise" %>
    ...
    <div class="form-horizontal">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h6 class="panel-title">Submission Student Wise </h6>
            </div>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="S.No">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="SubjectId" Value='<%# Eval("SubjectCode")%>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
