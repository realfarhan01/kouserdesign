<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="AddVehicle.aspx.vb" Inherits="Admin_AddVehicle" %>
...
<div class="form-horizontal" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Add Vehicle </h6></div>
                ...
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtVehicletype" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtVehicletype"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtTotseat" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTotseat"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Vehicle RCNo</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtRno" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtRno"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                       <div class="form-group">
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                         ...
                         <asp:BoundField DataField="VehicleCompany" HeaderText="Vehicle Company"></asp:BoundField>
                        <asp:BoundField DataField="VehicleNo" HeaderText="Vehicle No"></asp:BoundField>
                         ...
                         <asp:TemplateField>
                         <ItemTemplate>
                             <asp:LinkButton ID="LinkButton1" CommandArgument='<%# eval("VehicleId") %>' CommandName="edit1" runat="server">Edit</asp:LinkButton>
                         </ItemTemplate>
