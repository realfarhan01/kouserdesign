<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductReceipt.aspx.vb" Inherits="Admin_ProductReceipt" %>
                                ...
                                <tr>
                                    <td align="center" valign="top" width="49%">
                                        <div style="padding: 5px;">
                                            ...
                                            <br />
                                            <span class="style2">
                                                <%# Eval("SchoolAddress")%>, <%# Eval("Schoolcity")%>, <%# Eval("SchoolState")%>
                                                <br />
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" align="center" id="tblSchoolRec">
                                                        <tr>
                                                            <td align="center" valign="top" class="border-bottom">
                                                                <span class="style3">PRODUCT RECEIPT</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <td align="center" valign="top" class="border-bottom">
                                                    <table width="100%" cellpadding="2" cellspacing="0" align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="middle" width="55%" colspan="2" class="border-left border-bottom">PARTICULARS
                                                            </td>
                                                            <td align="left" valign="middle" width="15%" class="border-left border-bottom">QTY
                                                            </td>
                                                            <td align="right" valign="middle" width="20%" class="border-left border-right border-bottom">AMOUNT
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="middle" colspan="2" class="border-left">&nbsp;
                                                            </td>
                                                            <td align="left" valign="middle" class="border-left">&nbsp;
                                                            </td>
                                                            <td align="right" valign="middle" class="border-left border-right">&nbsp;
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="middle" class="border-left border-top">Total
                                                            </td>
                                                            <td align="right" colspan="2" valign="middle" class="border-top"></td>
                                            ...
                                            <tr>
                                                <td align="center" valign="top" class="border-left border-right border-bottom">
                                                    <table width="100%" cellpadding="3" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="middle" class="border-top" colspan="4">Total Amount -:<%# Eval("TotalAmount")%></td>
                                                            <td align="right" valign="middle" class="border-top border-left" colspan="4">Payment Mode -: <%# Eval("ReceiptStatus")%> <%# Eval("PMode")%></td>
                                                        </tr>
