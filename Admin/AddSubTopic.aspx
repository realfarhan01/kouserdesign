<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="AddSubTopic.aspx.vb" Inherits="AddSubTopic" %>
...
<div class="form-horizontal" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Subject Topic Detail </h6></div>
                ...
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtDetail" class="form-control" TextMode="multiLine" Columns="60" Rows="10" runat="server"></asp:TextBox>
                                
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Topic Sno</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtTopicSno" class="form-control"  runat="server"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ControlToValidate="txtTopicSno"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                ...
                <div class="panel-heading"><h6 class="panel-title">Topic List</h6></div>
                <div class="table-responsive">
                        ...
                        <Columns>
                         ...
                         <asp:BoundField DataField="Subjectname" HeaderText="Subject Name"></asp:BoundField>
                          <asp:BoundField DataField="Topic" HeaderText="Topic Name"></asp:BoundField>
                           <asp:BoundField DataField="TopicSno" HeaderText="Topic Sno"></asp:BoundField>
                       <%-- <asp:BoundField DataField="mtype" HeaderText="Vehicle Type"></asp:BoundField>--%>
                         ...
                         <asp:TemplateField>
                         <ItemTemplate>
                             <asp:LinkButton ID="LinkButton1" CommandArgument='<%# eval("TopicId") %>' CommandName="edit1" runat="server">Edit</asp:LinkButton>
                         </ItemTemplate>
