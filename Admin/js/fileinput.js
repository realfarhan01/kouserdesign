...
(function (factory) {
    ...
    tMain1 = '{preview}\n' +
      ...
      //  '       {upload}\n' +
        '       {browse}\n' +
        //' <button class="btn btn-default btn-sm" id="btnUploadMultiple" type="button">Upload</button>'
        '   </div>\n' +
        '</div>';
    tMain2 = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{browse}\n';
    ...
    tFooter = '<div class="file-thumbnail-footer">\n' +
        '    <div class="file-footer-caption" title="{caption}">{size}</div>\n' +
        '    {progress} {actions}\n' +
        '</div>';
    tActions = '<div class="file-actions">\n' +
      ...
      //  '    <div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<button type="button" showHideUploadFileButton class="kv-file-remove {removeClass}" ' + 'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
