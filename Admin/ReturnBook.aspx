<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="ReturnBook.aspx.vb" Inherits="ReturnBook" %>
...
<div class="form-horizontal" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Return Book </h6></div>
                ...
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtReturnDate" class="form-control datepicker" runat="server" AutoPostBack="True"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtReturnDate"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Extra Days</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtExtraDays" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtExtraDays"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtFine" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtFine"
                ErrorMessage="*" ValidationGroup="UserRegistration">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
