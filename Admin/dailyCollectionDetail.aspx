<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="dailyCollectionDetail.aspx.vb" Inherits="Admin_dailyCollectionDetail" %>
            ...
            <div id="dvContents">
                <div id="employeelistDiv" runat="server">
                    ...
                    <table class="nav-justified table table-bordered table-check" width="100%" border="1" cellpadding="0" cellspacing="0">
                        <%--<caption>Print Date:<%=Date.Today.ToString("dd/MM/yyyy") %></caption>--%>
                        <caption>
                        ...
                        <tr style="line-height: 26px; width:100%; border-bottom: 1px solid #ddd;">
                            <td style="width: 20%" align="left" >RECEIPT DATE</td>
                            <td style="width: 20%" align="left" >FEE HEAD</td>
                            <td style="width: 20%">CASH AMOUNT</td>
                            <td style="width: 20%">CHEQUE AMOUNT</td>
                            <td style="width: 20%">TOTAL COLLECTION</td>
                        </tr>
                        <asp:DataList runat="server" ID="DlDailyCollection" Width="100%" CssClass="nav-justified" OnItemDataBound="DlDailyCollection_ItemDataBound">
                            <ItemTemplate>
                                <div>
                                    <asp:HiddenField runat="server" ID="hdfDate" Value='<%# Eval("Dated")%>' />
                                </div>
                                <asp:Literal ID="Literal1" runat="server"></asp:Literal>
                                <tr style="line-height: 30px; border-top: 1px dashed black; border-bottom: 1px dashed black; font-weight:bold; width:100%">
                                    <td style="width: 20%">Total For Date&nbsp;<%# Eval("Dated")%></td>
                                    <td style="width: 20%"></td>
                                    <td style="width: 20%;"><%# Eval("CashAmount")%></td>
                                    <td style="width: 20%"><%# Eval("ChequeAmount")%></td>
                                    <td style="width: 20%"><%# Eval("TotalAmount")%></td>
                                </tr>
                            </ItemTemplate>
                        </asp:DataList>
                    </table>
