<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="ProductReceiptList.aspx.vb" Inherits="Admin_ProductReceiptList" %>
    ...
    <asp:Panel ID="pnlgrid" runat="server">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h6 class="panel-title">Product Receipt List</h6>
            ...
            <div class="table-responsive">
                <asp:GridView ID="DataDisplay" class="table table-bordered table-check" AutoGenerateColumns="false" runat="server">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ReceiptNoSession" HeaderText="Receipt No"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="PdDate" HeaderText="Paid Date"></asp:BoundField>
            ...
            <div class="panel panel-default">
                ...
                <div id="divchequeDetails" runat="server" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtBankName" class="form-control" runat="server"></asp:TextBox><span class="error" id="spanBankName"></span>
                        </div>
                        ...
                        <div class="panel">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <span id="spanErrorMsg" runat="server" style="color: red;"></span>
