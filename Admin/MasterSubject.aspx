<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="MasterSubject.aspx.vb" Inherits="Admin_MasterSubject" %>
...
<div class="form-horizontal" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Subject Master </h6></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtcode" class="form-control" runat="server"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtcode"
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                         ...
                         <asp:TemplateField>
                         <ItemTemplate>
                             <asp:LinkButton ID="LinkButton1" CommandArgument='<%# eval("subjectcode") %>' CommandName="edit1" runat="server">Edit</asp:LinkButton>
                         </ItemTemplate>
